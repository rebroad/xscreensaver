      ...
      while ((st->xgwa.width + st->overlap) > cx * st->width)
        {
          if (random() % 2)
            {
              /* block1 */
              XDrawLine(st->dpy, st->frame, st->agc, (cx * st->width) + (st->width / 2), (cy * st->height), (cx * st->width) + (st->width), (cy * st->height) + (st->height / 2));
              XDrawLine(st->dpy, st->frame, st->agc, (cx * st->width), (cy * st->height) + (st->height / 2), (cx * st->width) + (st->width / 2), (cy * st->height) + (st->height));
            }
          else
            {
              /* block 2 */
              XDrawLine(st->dpy, st->frame, st->agc, (cx * st->width) + (st->width / 2), (cy * st->height), (cx * st->width), (cy * st->height) + (st->height / 2));
              XDrawLine(st->dpy, st->frame, st->agc, (cx * st->width) + (st->width), (cy * st->height) + (st->height / 2), (cx * st->width) + (st->width / 2), (cy * st->height) + (st->height));
            }
          cx++;
        }
      cy++;
      ...
      while (st->xgwa.width + st->overlap > cx * st->width)
        {
          if (random() % 2)
            {
              /* block1 */
              XDrawArc(st->dpy, st->frame, st->agc, ((cx * st->width) - (st->width / 2)), ((cy * st->height) - (st->height / 2)), st->width, st->height, 0, -5760);
              XDrawArc(st->dpy, st->frame, st->agc, ((cx * st->width) + (st->width / 2)), ((cy * st->height) + (st->height / 2)), st->width, st->height, 11520, -5760);
            }
          else
            {
              /* block 2 */
              XDrawArc(st->dpy, st->frame, st->agc, ((cx * st->width) + (st->width / 2)), ((cy * st->height) - (st->height / 2)), st->width, st->height, 17280, -5760);
              XDrawArc(st->dpy, st->frame, st->agc, ((cx * st->width) - (st->width / 2)), ((cy * st->height) + (st->height / 2)), st->width, st->height, 0, 5760);
            }
          cx++;
        }
