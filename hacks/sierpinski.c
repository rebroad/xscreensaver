...
ModStruct sierpinski_description=
  {"sierpinski", "init_sierpinski", "draw_sierpinski", (char *) NULL, "refresh_sierpinski", "init_sierpinski", "free_sierpinski", &sierpinski_opts, 400000, 2000, 100, 1, 64, 1.0, "", "Shows Sierpinski's triangle", 0, NULL};
  ...
  for (i= 0; i < sp->corners; i++)
    {
      ...
      XDrawPoints(display, MI_WINDOW(mi), gc, sp->pointBuffer [ i ], sp->npoints [ i ], CoordModeOrigin);
      sp->npoints [ i ]= 0;
    }
