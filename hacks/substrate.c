...
static inline void start_crack(
  struct field *f,
  crack *cr)
{
  ...
  struct field *f)
{
  ...
  f->off_img= (unsigned long *) xrealloc(f->off_img, sizeof(unsigned long) * f->width * f->height);
