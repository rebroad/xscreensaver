...
ModStruct rotor_description=
  {"rotor", "init_rotor", "draw_rotor", (char *) NULL, "refresh_rotor", "init_rotor", "free_rotor", &rotor_opts, 100, 4, 100, -6, 64, 0.3, "", "Shows Tom's Roto-Rooter", 0, NULL};
    ...
    ModeInfo *mi)
{
  ...
  XSetLineAttributes(MI_DISPLAY(mi), MI_GC(mi), rp->linewidth, LineSolid, CapButt, JoinMiter);
  ...
  XSetLineAttributes(MI_DISPLAY(mi), MI_GC(mi), 1, LineSolid, CapButt, JoinMiter);
}
