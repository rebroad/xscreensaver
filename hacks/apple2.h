...
extern apple2_sim_t *apple2_start(Display *, Window, int delay, void (*)(apple2_sim_t *, int *stepno, double *next_actiontime));
...
void a2_add_disk_item(apple2_state_t *st, char *name, unsigned char *data, int len, char type);
...
void a2_invalidate(apple2_state_t *st);
void a2_poke(apple2_state_t *st, int addr, int val);
void a2_display_image_loading(apple2_state_t *st, unsigned char *image, int lineno);
