                          ...
                          if (st->robots [ x ].lasers [ y ].active == 0)
                            {
                              ...
                              else if (target_y > st->robots [ x ].new_y)
                                {
      ...
      for (y= 0; y < st->NUM_LASERS; y++)
        {
          if (st->robots [ x ].lasers [ y ].active)
            {
              if (st->black) XDrawLine(st->dpy, st->window, st->black, st->robots [ x ].lasers [ y ].start_x, st->robots [ x ].lasers [ y ].start_y, st->robots [ x ].lasers [ y ].end_x, st->robots [ x ].lasers [ y ].end_y);
              move_laser(st, x, y);
              if (st->robots [ x ].lasers [ y ].active)
                XDrawLine(st->dpy, st->window, st->robots [ x ].laser_color, st->robots [ x ].lasers [ y ].start_x, st->robots [ x ].lasers [ y ].start_y, st->robots [ x ].lasers [ y ].end_x, st->robots [ x ].lasers [ y ].end_y);
              else if (st->black)
                XDrawLine(st->dpy, st->window, st->black, st->robots [ x ].lasers [ y ].start_x, st->robots [ x ].lasers [ y ].start_y, st->robots [ x ].lasers [ y ].end_x, st->robots [ x ].lasers [ y ].end_y);
            }
        }
    }
      ...
      for (y= 0; y < 8; y++)
        {
          if (st->mother->lasers [ y ].active)
            {
              if (st->black) XDrawLine(st->dpy, st->window, st->black, st->mother->lasers [ y ].start_x, st->mother->lasers [ y ].start_y, st->mother->lasers [ y ].end_x, st->mother->lasers [ y ].end_y);
              move_laser(st, -1, y);
              if (st->mother->lasers [ y ].active)
                XDrawLine(st->dpy, st->window, st->mother->laser_color, st->mother->lasers [ y ].start_x, st->mother->lasers [ y ].start_y, st->mother->lasers [ y ].end_x, st->mother->lasers [ y ].end_y);
              else if (st->black)
                XDrawLine(st->dpy, st->window, st->black, st->mother->lasers [ y ].start_x, st->mother->lasers [ y ].start_y, st->mother->lasers [ y ].end_x, st->mother->lasers [ y ].end_y);
            }
        }
    }
}
      ...
      if (st->mother->active)
        {
          ...
          else if (st->mother->old_x > st->mother->new_x)
            {
