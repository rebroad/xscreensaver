...
extern Pixmap file_to_pixmap(Display *, Window, const char *filename, int *width_ret, int *height_ret, Pixmap *mask_ret);

extern Pixmap image_data_to_pixmap(Display *, Window, const unsigned char *image_data, unsigned long data_size, int *width_ret, int *height_ret, Pixmap *mask_ret);
 ...
 */
extern XImage *image_data_to_ximage(Display *, Visual *, const unsigned char *image_data, unsigned long data_size);
