...
{
  tty_state *st= tty->state;
  unsigned char *top= (unsigned char *) (tty->grid + tty->width * st->scroll.y1);
  unsigned char *bot= (unsigned char *) (tty->grid + (tty->width * st->scroll.y2));
  int total= bot - top;
  ...
  if (tty->debug_p > (ok ? 1 : 0))
    {
      ...
      *s= 0;
      ...
      fprintf(stderr, "%s: %3s: %s%s%s\n", progname, kind, (ok ? "" : "Unimplemented: "), log, buf);
    }
}
                ...
                case ')' : /* ESC ( ? */
                  {
                    ...
                    *gg= 0;
                    switch (st->buf [ 2 ])
                      {
                        case '0' :
                          LOG("G0-designate 94-set: Line Drawing");
                          *gg= TTY_SYMBOLS;
                          break;
      ...
      switch (c)
        {
                ...
                switch (av [ i ])
                  {
                    ...
                    case 30 :
                      LOG("Set foreground color 1");
                      set_color(tty, True, 0);
                      break;
                    case 31 :
                      LOG("Set foreground color 2");
                      set_color(tty, True, 1);
                      break;
                    case 32 :
                      LOG("Set foreground color 3");
                      set_color(tty, True, 2);
                      break;
                    case 33 :
                      LOG("Set foreground color 4");
                      set_color(tty, True, 3);
                      break;
                    case 34 :
                      LOG("Set foreground color 5");
                      set_color(tty, True, 4);
                      break;
                    case 35 :
                      LOG("Set foreground color 6");
                      set_color(tty, True, 5);
                      break;
                    case 36 :
                      LOG("Set foreground color 7");
                      set_color(tty, True, 6);
                      break;
                    case 37 :
                      LOG("Set foreground color 8");
                      set_color(tty, True, 7);
                      break;

                    case 38 :
                      LOG("Set foreground color N");
                      if (av [ i ] == 5)
                        {
                    ...
                    case 40 :
                      LOG("Set background color 1");
                      set_color(tty, False, 0);
                      break;
                    case 41 :
                      LOG("Set background color 2");
                      set_color(tty, False, 1);
                      break;
                    case 42 :
                      LOG("Set background color 3");
                      set_color(tty, False, 2);
                      break;
                    case 43 :
                      LOG("Set background color 4");
                      set_color(tty, False, 3);
                      break;
                    case 44 :
                      LOG("Set background color 5");
                      set_color(tty, False, 4);
                      break;
                    case 45 :
                      LOG("Set background color 6");
                      set_color(tty, False, 5);
                      break;
                    case 46 :
                      LOG("Set background color 7");
                      set_color(tty, False, 6);
                      break;
                    case 47 :
                      LOG("Set background color 8");
                      set_color(tty, False, 7);
                      break;

                    case 48 :
                      LOG("Set background color N");
                      if (av [ i ] == 5)
                        {
          ...
          case 's' :
            LOG("Save Current Cursor Position");
            st->saved.flags= st->flags;
            st->saved.lcf= st->lcf;
            st->saved.x= tty->x;
            st->saved.y= tty->y;
          ...
          case 'u' :
            LOG("Restore Saved Cursor Position");
            st->flags= st->saved.flags;
            st->lcf= st->saved.lcf;
            tty->x= st->saved.x;
            tty->y= st->saved.y;
      ...
      switch (c)
        {            /* These commands await ST  */
          ...
          case 'A' :
            ...
            break;
          case 'B' :
            LOG("VT52 Cursor down");
            tty->y++;
            scrolled_p= True;
            /* Set lcf to False here? */
            break;
          case 'C' :
            LOG("VT52 Cursor right");
            tty->x++;
            scrolled_p= True;
            /* Set lcf to False here? */
            break;
          ...
          case 'E' :
            ...
            break;
          case 'F' :
            LOG("VT52 Graphics mode");
            st->flags|= TTY_SYMBOLS;
            break;
          case 'G' :
            LOG("VT52 Exit graphics");
            st->flags&= ~TTY_SYMBOLS;
            break;
          case 'H' :
            LOG("Set tab");
