  ...
  GC gc)
{
  ...
  st->pix= XCreatePixmap(display, window, st->width, st->height, xgwa.depth);
...
static void* binaryhorizon_init(
  Display* display,
  Window window)
{
  XWindowAttributes xgwa;
...
static unsigned long binaryhorizon_draw(
  Display* display,
  Window win,
  void* closure)
{
  ...
  if (random() % 10000 > 9975)
    { /* was 9950, I wanted it slower to change*/
...
static void binaryhorizon_reshape(
  Display* display,
  Window win,
  void* closure,
  unsigned int w,
...
static Bool binaryhorizon_event(
  Display* display,
  Window win,
  void* closure,
  XEvent* event)
...
/* delete everything */
static void binaryhorizon_free(
  Display* display,
  Window win,
  void* closure)
{
