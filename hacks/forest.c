...
static long colorM [ 12 ]= {0xff0000, 0xff8000, 0xffff00, 0x80ff00, 0x00ff00, 0x00ff80, 0x00ffff, 0x0080ff, 0x0000ff, 0x8000ff, 0xff00ff, 0xff0080};

static long colorV [ 12 ]= {0x0a0000, 0x0a0500, 0x0a0a00, 0x050a00, 0x000a00, 0x000a05, 0x000a0a, 0x00050a, 0x00000a, 0x05000a, 0x0a000a, 0x0a0005};
  ...
  for (i= 0; i < widths; i++)
    {
      ...
      XDrawLine(display, MI_WINDOW(mi), gc, xs1 + (xs2 - xs1) * i / widths, ys1 + (ys2 - ys1) * i / widths, xe1 + (xe2 - xe1) * i / widths, ye1 + (ye2 - ye1) * i / widths);
    }
}

static void draw_tree_rec(
  ModeInfo *mi,
  double thick,
  int x,
  int y,
