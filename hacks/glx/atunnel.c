...
ModStruct atunnel_description=
  {"atunnel", "init_atunnel", "draw_atunnel", NULL, "draw_atunnel", "init_atunnel", "free_atunnel", &atunnel_opts, 1000, 1, 2, 1, 4, 1.0, "", "OpenGL advanced tunnel screensaver", 0, NULL};
#endif
  ...
  int t_num)
{
  ...
  if ((teximage= image_data_to_ximage(MI_DISPLAY(mi), MI_VISUAL(mi), data, size)) == None)
    {
