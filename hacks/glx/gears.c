...
static int
  ctube(
    ...
    Bool wire)
{
  tube(0, 0, width / 2, 0, 0, -width / 2, diameter, 0, 32, True, True, wire);
  return 0; /* #### */
}
    ...
    ModeInfo *mi)
{
  ...
  bp->armature_polygons+= arm(4.0, 1.0, 0.5, 2.0, 1.0, wire); /* arm 1 */
  glPopMatrix();
  ...
  glRotatef(-10, 0, 1, 0);
  glTranslatef(-2.2, 0, 0);
  bp->armature_polygons+= arm(4.0, 1.0, 0.5, 2.0, 1.0, wire); /* arm 2 */
  glPopMatrix();
  ...
  glRotatef(-10, 0, 1, 0);
  glTranslatef(-2.2, 0, 0);
  bp->armature_polygons+= arm(4.0, 1.0, 0.5, 2.0, 1.0, wire); /* arm 3 */
  glPopMatrix();
