...
ENTRYPOINT void reshape_surface(
  ModeInfo *mi,
  int width,
  int height)
{
...
ENTRYPOINT Bool surface_handle_event(
  ModeInfo *mi,
  XEvent *event)
{
  surfacestruct *sp= &surface [ MI_SCREEN(mi) ];
