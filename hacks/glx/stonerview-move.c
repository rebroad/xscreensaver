  ...
  stonerview_state *st)
{
  ...
  st->theta= new_osc_linear(st,
    new_osc_velowrap(st, 0, 36000, new_osc_multiplex(st, new_osc_randphaser(st, 300, 600), new_osc_constant(st, 25), new_osc_constant(st, 75), new_osc_constant(st, 50), new_osc_constant(st, 100))),
  ...
  st->rad= new_osc_buffer(st, new_osc_multiplex(st, new_osc_randphaser(st, 250, 500), new_osc_bounce(st, -1000, 1000, 10), new_osc_bounce(st, 200, 1000, -15), new_osc_bounce(st, 400, 1000, 10), new_osc_bounce(st, -1000, 1000, -20)));
...
void stonerview_move_increment(
  stonerview_state *st)
{
  int ix, val;
  /*  double fval; */
