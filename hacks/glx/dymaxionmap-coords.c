...
static void s_tri_info(double x, double y, double z, int *tri, int *lcd);
static void dymax_point(int tri, int lcd, double x, double y, double z, double *dx, double *dy);
  ...
  switch (tri)
    {
      case 1 :
        rotate(240.0, &x, &y);
        *px= x + 2.0;
        *py= y + 7.0 / (2.0 * sqrt(3.0));
        break;
      case 2 :
        rotate(300.0, &x, &y);
        *px= x + 2.0;
        *py= y + 5.0 / (2.0 * sqrt(3.0));
        break;
      case 3 :
        rotate(0.0, &x, &y);
        *px= x + 2.5;
