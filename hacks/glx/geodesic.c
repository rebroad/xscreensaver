    ...
    XYZ p3)
{
  ...
  if (r <= 0)
  ...
  else if (r >= 1) /* solid triangular face */
    {
      ...
      do_normal(p1.x, p1.y, p1.z, p2.x, p2.y, p2.z, p3.x, p3.y, p3.z);
  ...
  else /* mesh: triangular face with a triangular hole */
    {
      ...
      do_normal(p3.x, p3.y, p3.z, p3b.x, p3b.y, p3b.z, p1b.x, p1b.y, p1b.z);
      ...
      do_normal(p1b.x, p1b.y, p1b.z, p2b.x, p2b.y, p2b.z, p2b.x * d, p2b.y * d, p2b.z * d);
      glVertex3f(p1b.x, p1b.y, p1b.z);
      glVertex3f(p2b.x, p2b.y, p2b.z);
      ...
      do_normal(p2b.x, p2b.y, p2b.z, p3b.x, p3b.y, p3b.z, p3b.x * d, p3b.y * d, p3b.z * d);
      glVertex3f(p2b.x, p2b.y, p2b.z);
      glVertex3f(p3b.x, p3b.y, p3b.z);
      ...
      do_normal(p3b.x, p3b.y, p3b.z, p1b.x, p1b.y, p1b.z, p1b.x * d, p1b.y * d, p1b.z * d);
      glVertex3f(p3b.x, p3b.y, p3b.z);
      glVertex3f(p1b.x, p1b.y, p1b.z);
      glVertex3f(p1b.x * d, p1b.y * d, p1b.z * d);
      glVertex3f(p3b.x * d, p3b.y * d, p3b.z * d);
