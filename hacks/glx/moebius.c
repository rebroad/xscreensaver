...
ModStruct moebius_description=
  {"moebius", "init_moebius", "draw_moebius", (char *) NULL, "draw_moebius", "change_moebius", (char *) NULL, &moebius_opts, 1000, 1, 1, 1, 4, 1.0, "", "Shows Moebius Strip II, an Escher-like GL scene with ants", 0, NULL};
    ...
    float radius)
{
	...
	gluDeleteQuadric(quadObj);
#else
  cone(0, 0, 0, 0, 0, radius * 3, radius, 0, 8, True, True, False);
#endif
  return True;
}
