...
int glschool_computeGroupVectors(
  School *s,
  Fish *ref,
  double *avoidance,
  double *centroid,
...
void glschool_computeAccelerations(
  School *s)
{
  int i;
  int j;
