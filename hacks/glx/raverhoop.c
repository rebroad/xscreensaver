/* raverhoop, Copyright © 2016-2025 Jamie Zawinski <jwz@jwz.org>
 *
  ...
  switch (n)
    {
      ...
      case 1 :
      case 2 :
        add_oscillator(mi, &bp->midpoint.z, 1, bp->radius * (0.8 + frand(0.2)) * (random() & 1 ? 1 : -1), (3 + (random() % 10)));
        break;
      case 3 :
      case 4 :
      case 5 :
        add_oscillator(mi, &bp->tilt, 1, -(GLfloat) (random() % 15), 3 + (random() % 20));
        break;
      case 6 :
      case 7 :
      case 8 :
        add_oscillator(mi, &bp->axial_radius, 1, 0.1 + bp->radius * frand(1.4), 1 + (random() % 4));
        break;
      case 9 :
      case 10 :
        add_oscillator(mi, &bp->speed, 3, (0.7 + frand(0.9)) * (random() & 1 ? 1 : -1), ((random() % 5) ? 1 : 2 + (random() % 5)));
        break;
      case 11 :
        add_oscillator(mi, &bp->spin, 0.1, 180 * (1 + (random() % 2)), 2 * (1 + (random() % 5)));
        break;
      default :
        abort();
        break;
