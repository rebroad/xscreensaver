 ...
 */
extern void texture_string_metrics(texture_font_data *, const char *, XCharStruct *metrics_ret, int *ascent_ret, int *descent_ret);
 ...
 */
void print_texture_label(Display *, texture_font_data *, int window_width, int window_height, int position, const char *string);

/* Renders the given string into the prevailing texture.
   Returns the metrics of the text, and size of the texture.
 */
void string_to_texture(texture_font_data *, const char *, XCharStruct *extents_ret, int *tex_width_ret, int *tex_height_ret);
