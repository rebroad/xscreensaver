...
ModStruct polytopes_description=
  {"polytopes", "init_polytopes", "draw_polytopes", NULL, "draw_polytopes", "change_polytopes", NULL, &polytopes_opts, 25000, 1, 1, 1, 1.0, 4, "", "Shows one of the six regular 4d polytopes rotating in 4d", 0, NULL};
      ...
      for (i= 0; i < num_face; i++)
        {
          ...
          if (color_mode == COLORS_DEPTH)
            {
              if (display_mode == DISP_TRANSPARENT)
                glMaterialfv(GL_FRONT_AND_BACK, GL_AMBIENT_AND_DIFFUSE, face_color_trans [ i ]);
              else
                glMaterialfv(GL_FRONT_AND_BACK, GL_AMBIENT_AND_DIFFUSE, face_color [ i ]);
            }
          normal(v [ face [ i * vert_per_face ] ], v [ face [ i * vert_per_face + 1 ] ], v [ face [ i * vert_per_face + 2 ] ], n);
          glNormal3fv(n);
  ...
  ModeInfo *mi)
{
  ...
  draw(mi, v, edge_5, NUM_EDGE_5, (int *) face_5, NUM_FACE_5, VERT_PER_FACE_5, hp->edge_color_5, hp->face_color_5, hp->face_color_trans_5);
}
  ...
  ModeInfo *mi)
{
  ...
  draw(mi, v, edge_8, NUM_EDGE_8, (int *) face_8, NUM_FACE_8, VERT_PER_FACE_8, hp->edge_color_8, hp->face_color_8, hp->face_color_trans_8);
}
  ...
  ModeInfo *mi)
{
  ...
  draw(mi, v, edge_16, NUM_EDGE_16, (int *) face_16, NUM_FACE_16, VERT_PER_FACE_16, hp->edge_color_16, hp->face_color_16, hp->face_color_trans_16);
}
  ...
  ModeInfo *mi)
{
  ...
  draw(mi, v, edge_24, NUM_EDGE_24, (int *) face_24, NUM_FACE_24, VERT_PER_FACE_24, hp->edge_color_24, hp->face_color_24, hp->face_color_trans_24);
}


/* Draw a 120-cell {5,3,3} projected into 3d. */
static void cell_120(
  ModeInfo *mi)
{
  polytopesstruct *hp= &poly [ MI_SCREEN(mi) ];
  ...
  draw(mi, v, edge_120, NUM_EDGE_120, (int *) face_120, NUM_FACE_120, VERT_PER_FACE_120, hp->edge_color_120, hp->face_color_120, hp->face_color_trans_120);
}


/* Draw a 600-cell {3,3,5} projected into 3d. */
static void cell_600(
  ModeInfo *mi)
{
  polytopesstruct *hp= &poly [ MI_SCREEN(mi) ];
  ...
  draw(mi, v, edge_600, NUM_EDGE_600, (int *) face_600, NUM_FACE_600, VERT_PER_FACE_600, hp->edge_color_600, hp->face_color_600, hp->face_color_trans_600);
}
...
static void colors(
  ...
  float face_color_trans [][ 4 ],
  float alpha,
  float min_edge_depth,
  float max_edge_depth,
  float min_face_depth,
  float max_face_depth)
{
  int i, j;
  float depth;
  ...
  ModeInfo *mi)
{
  polytopesstruct *hp= &poly [ MI_SCREEN(mi) ];
  /* 5-cell. */
  colors(vert_5, edge_5, NUM_EDGE_5, (int *) face_5, NUM_FACE_5, VERT_PER_FACE_5, hp->edge_color_5, hp->face_color_5, hp->face_color_trans_5, 0.5, MIN_EDGE_DEPTH_5, MAX_EDGE_DEPTH_5, MIN_FACE_DEPTH_5, MAX_FACE_DEPTH_5);

  /* 8-cell. */
  colors(vert_8, edge_8, NUM_EDGE_8, (int *) face_8, NUM_FACE_8, VERT_PER_FACE_8, hp->edge_color_8, hp->face_color_8, hp->face_color_trans_8, 0.4, MIN_EDGE_DEPTH_8, MAX_EDGE_DEPTH_8, MIN_FACE_DEPTH_8, MAX_FACE_DEPTH_8);

  /* 16-cell. */
  colors(vert_16, edge_16, NUM_EDGE_16, (int *) face_16, NUM_FACE_16, VERT_PER_FACE_16, hp->edge_color_16, hp->face_color_16, hp->face_color_trans_16, 0.25, MIN_EDGE_DEPTH_16, MAX_EDGE_DEPTH_16, MIN_FACE_DEPTH_16, MAX_FACE_DEPTH_16);

  /* 24-cell. */
  colors(vert_24, edge_24, NUM_EDGE_24, (int *) face_24, NUM_FACE_24, VERT_PER_FACE_24, hp->edge_color_24, hp->face_color_24, hp->face_color_trans_24, 0.25, MIN_EDGE_DEPTH_24, MAX_EDGE_DEPTH_24, MIN_FACE_DEPTH_24, MAX_FACE_DEPTH_24);

  /* 120-cell. */
  colors(vert_120, edge_120, NUM_EDGE_120, (int *) face_120, NUM_FACE_120, VERT_PER_FACE_120, hp->edge_color_120, hp->face_color_120, hp->face_color_trans_120, 0.15, MIN_EDGE_DEPTH_120, MAX_EDGE_DEPTH_120, MIN_FACE_DEPTH_120, MAX_FACE_DEPTH_120);

  /* 600-cell. */
  colors(vert_600, edge_600, NUM_EDGE_600, (int *) face_600, NUM_FACE_600, VERT_PER_FACE_600, hp->edge_color_600, hp->face_color_600, hp->face_color_trans_600, 0.06, MIN_EDGE_DEPTH_600, MAX_EDGE_DEPTH_600, MIN_FACE_DEPTH_600, MAX_FACE_DEPTH_600);
}
...
ENTRYPOINT void reshape_polytopes(
  ModeInfo *mi,
  int width,
  int height)
{
...
ENTRYPOINT Bool polytopes_handle_event(
  ModeInfo *mi,
  XEvent *event)
{
  polytopesstruct *pp= &poly [ MI_SCREEN(mi) ];
...
ENTRYPOINT void init_polytopes(
  ModeInfo *mi)
{
  polytopesstruct *pp;
 ...
 *-----------------------------------------------------------------------------
 */
ENTRYPOINT void draw_polytopes(
  ModeInfo *mi)
{
...
#ifndef STANDALONE
ENTRYPOINT void change_polytopes(
  ModeInfo *mi)
{
  polytopesstruct *hp= &poly [ MI_SCREEN(mi) ];
...
ENTRYPOINT void free_polytopes(
  ModeInfo *mi)
{
  polytopesstruct *hp= &poly [ MI_SCREEN(mi) ];
