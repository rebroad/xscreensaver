...
ModStruct pulsar_description=
  {"pulsar", "init_pulsar", "draw_pulsar", NULL, "draw_pulsar", "init_pulsar", "free_pulsar", &pulsar_opts, 1000, 1, 2, 1, 4, 1.0, "", "OpenGL pulsar", 0, NULL};
#endif
