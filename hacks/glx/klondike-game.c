...
static game_state_struct *clone_game_state(
...
static void remove_card_from_deck(
...
static game_state_struct *move_card_to_foundation(
  klondike_configuration *bp,
  game_state_struct *game_state,
  card_struct *card)
{
...
static game_state_struct *move_king_to_empty_tableau(
  klondike_configuration *bp)
{
...
static int can_move_to_tableau(
  game_state_struct *game_state,
  card_struct *card,
  int toPile)
{
...
static game_state_struct *move_tableau_base_card_to_tableau(
  klondike_configuration *bp)
{
  game_state_struct *game_state= bp->game_state;
  game_state_struct *ret= clone_game_state(game_state);
...
static game_state_struct *reveal_foundation_move(
  klondike_configuration *bp)
{
  game_state_struct *ret= clone_game_state(bp->game_state);
  for (int i= 0; i < 4; i++)
...
static game_state_struct *move_tableau_base_card_to_foundation(
  klondike_configuration *bp)
{
  game_state_struct *ret= clone_game_state(bp->game_state);
  for (int i= 0; i < 7; i++)
...
static game_state_struct *move_waste_to_foundation(
  klondike_configuration *bp)
{
  game_state_struct *ret= clone_game_state(bp->game_state);
  if (ret->waste_size > 0)
...
static game_state_struct *move_waste_to_tableau(
  klondike_configuration *bp)
{
  game_state_struct *ret= clone_game_state(bp->game_state);
  if (ret->waste_size > 0)
...
static game_state_struct *move_deck_to_waste(
  klondike_configuration *bp)
{
  game_state_struct *ret= clone_game_state(bp->game_state);
...
static game_state_struct *turn_over_last_tableau_card(
  klondike_configuration *bp)
{
  game_state_struct *ret= clone_game_state(bp->game_state);
  for (int i= 0; i < 7; i++)
...
static game_state_struct *next_move_inner(
  klondike_configuration *bp)
{
...
game_state_struct *klondike_next_move(
  klondike_configuration *bp)
{
  game_state_struct *ret= NULL;
