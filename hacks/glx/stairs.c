...
ModStruct stairs_description=
  {"stairs", "init_stairs", "draw_stairs", NULL, "draw_stairs", "change_stairs", "free_stairs", &stairs_opts, 1000, 1, 1, 1, 4, 1.0, "", "Shows Infinite Stairs, an Escher-like scene", 0, NULL};
...
#else
  {
    XImage *img= image_data_to_ximage(mi->dpy, mi->xgwa.visual, wood_png, sizeof(wood_png));
