...
extern void glsl_Rotate(GLfloat c [ 16 ], GLfloat angle, GLfloat x, GLfloat y, GLfloat z);
...
extern void glsl_Perspective(GLfloat c [ 16 ], GLfloat fovy, GLfloat aspect, GLfloat z_near, GLfloat z_far);

/* Add an orthographic projection to a 4x4 column-major matrix. */
extern void glsl_Orthographic(GLfloat c [ 16 ], GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat nearval, GLfloat farval);
