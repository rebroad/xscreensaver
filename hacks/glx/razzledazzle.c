...
extern const struct gllist
  *ships_ship1,
  *ships_ship2, *ships_ship3, *ships_ship4,
    ...
    ModeInfo *mi)
{
  ...
  if (bp->ncolors < 3)
    make_random_colormap(0, 0, 0, bp->colors, &bp->ncolors, True, False, 0, False);
  else
    make_smooth_colormap(0, 0, 0, bp->colors, &bp->ncolors, False, False, False);
