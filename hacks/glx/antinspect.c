...
ModStruct antinspect_description=
  {"antinspect", "init_antinspect", "draw_antinspect", (char *) NULL, "draw_antinspect", "change_antinspect", (char *) NULL, &antinspect_opts, 1000, 1, 1, 1, 4, 1.0, "", "draws some ants", 0, NULL};
#endif
...
/* draw the scene */
static Bool draw_antinspect_strip(
  ModeInfo *mi)
{
...
ENTRYPOINT void reshape_antinspect(
  ModeInfo *mi,
  int width,
  int height)
{
...
ENTRYPOINT Bool antinspect_handle_event(
  ModeInfo *mi,
  XEvent *event)
{
  antinspectstruct *mp= &antinspect [ MI_SCREEN(mi) ];
...
ENTRYPOINT void init_antinspect(
  ModeInfo *mi)
{
  antinspectstruct *mp;
...
ENTRYPOINT void draw_antinspect(
  ModeInfo *mi)
{
  antinspectstruct *mp;
...
#ifndef STANDALONE
ENTRYPOINT void change_antinspect(
  ModeInfo *mi)
{
  antinspectstruct *mp= &antinspect [ MI_SCREEN(mi) ];
...
ENTRYPOINT void free_antinspect(
  ModeInfo *mi)
{
  antinspectstruct *mp= &antinspect [ MI_SCREEN(mi) ];
