  ...
  if (g->inner_r2)
    {
      ...
      if (g->spokes)
        {
          polys+= draw_spokes(g->spokes, g->spoke_thickness, steps, ra, rb, za, zb, g->tooth_slope, wire_p);
        }
    ...
    tooth_face *irim) /* inner rim (the hole)  */
{
  ...
  th [ 0 ]= -tw * (g->size == INVOLUTE_SMALL ? 0.5 : g->size == INVOLUTE_MEDIUM ? 0.41 :
                                                                                  0.45);
  th [ 1 ]= -tw * 0.375;
  th [ 2 ]= -tw * 0.300;
  th [ 3 ]= -tw * 0.230;
