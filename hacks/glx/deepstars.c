...
ModStruct deepstars_description=
  {"deepstars", "init_deepstars", "draw_deepstars", NULL, "draw_deepstars", "init_deepstars", "free_deepstars", &deepstars_opts, 1000, 1, 2, 1, 4, 1.0, "", "Animates texture mapped sphere (deepstars)", 0, NULL};
#endif
          ...
          for (k= 0; k < gp->starcount / sizes; k++)
            {
              ...
              GLfloat z= ((random() & 1) ? frand(1) - 0.5 : (BELLRAND(1) - 0.5) / 20); /* milky way */
