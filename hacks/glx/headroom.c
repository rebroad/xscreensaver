...
extern const struct gllist
  *headroom_model_skull_half,
  *headroom_model_jaw_half,
...
static const struct gllist *const *all_objs []= {
  &headroom_model_skull_half,
  &headroom_model_jaw_half,
  &headroom_model_teeth_upper_half,
  &headroom_model_teeth_lower_half,
  &headroom_model_suit_half,
  &headroom_model_suit_cap_half,
  &headroom_model_shirt_half,
  &headroom_model_tie_half,
  &headroom_model_mask_half,
};
    ...
    ModeInfo *mi)
{
...

  {
    ...
    bp->rot3= make_rotator(spin_speed_2, spin_speed_2, spin_speed_2, spin_accel_2, wander_speed_2, True);
