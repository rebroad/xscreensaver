...
ModStruct pipes_description=
  {"pipes", "init_pipes", "draw_pipes", NULL, "draw_pipes", "change_pipes", "free_pipes", &pipes_opts, 1000, 2, 5, 500, 4, 1.0, "", "Shows a selfbuilding pipe system", 0, NULL};
    ...
    int direction)
{
  ...
  if (! (direction & 4))
    glRotatef(90.0, (direction & 2) ? 0.0 : 1.0, (direction & 2) ? 1.0 : 0.0, 0.0);
