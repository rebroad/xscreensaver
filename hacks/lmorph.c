  ...
  if (st->figType & FT_CLOSED)
    {
      ...
      for (q= 0; q < st->numPoints; q++)
        {
          st->a [ st->numFigs ][ q ].x= mx / 2 + ry * (0.8 - 0.2 * sin(30 * TWO_PI * q / mp)) * sin(TWO_PI * (double) q / mp);
          st->a [ st->numFigs ][ q ].y= my / 2 + ry * (0.8 - 0.2 * sin(30 * TWO_PI * q / mp)) * cos(TWO_PI * (double) q / mp);
        }
      st->a [ st->numFigs ][ mp ].x= st->a [ st->numFigs ][ 0 ].x;
      st->a [ st->numFigs ][ mp ].y= st->a [ st->numFigs ][ 0 ].y;
      ++st->numFigs;
  ...
  if (st->figType & FT_OPEN)
    {
      ...
      for (q= 0; q < st->numPoints; q++)
        {
          ...
          st->a [ st->numFigs ][ q ].y= (1.0 - sin(((double) q / mp) * TWO_PI)) * my / 2.0;
        }
      ++st->numFigs;
      ...
      for (q= 0; q < st->numPoints; q++)
        {
          ...
          st->a [ st->numFigs ][ q ].y= (1.0 - cos(((double) q / mp) * 3 * TWO_PI)) * my / 2.0;
        }
      ++st->numFigs;
      ...
      for (q= 0; q < st->numPoints; q++)
        {
          st->a [ st->numFigs ][ q ].x= mx / 2 + ry * sin(5 * TWO_PI * (double) q / mp) * ((double) q / mp);
          st->a [ st->numFigs ][ q ].y= my / 2 + ry * cos(5 * TWO_PI * (double) q / mp) * ((double) q / mp);
        }
      ++st->numFigs;
      ...
      for (q= 0; q < st->numPoints; q++)
        {
          st->a [ st->numFigs ][ q ].x= mx / 2 + ry * sin(6 * TWO_PI * (double) q / mp) * ((double) q / mp);
          st->a [ st->numFigs ][ q ].y= my / 2 - ry * cos(6 * TWO_PI * (double) q / mp) * ((double) q / mp);
        }
      ++st->numFigs;
      ...
      for (q= 0; q < st->numPoints; q++)
        {
          st->a [ st->numFigs ][ q ].x= ((double) q / mp) * mx;
          st->a [ st->numFigs ][ q ].y= (1.0 - sin(((double) q / mp) * 5 * TWO_PI)) * my / 2.0;
        }
      ++st->numFigs;
    }
  ...
  for (q= st->numPoints; q; q--)
    {
      ...
      fg= st->currGamma + 1.67 * speed * exp(-200.0 * (st->currGamma - 0.5 + 0.7 * speed) * (st->currGamma - 0.5 + 0.7 * speed));

      f1g= 1.0 - fg;
      pa->x= (short) (f1g * f1g * f1g * pa1->x + f1g * f1g * fg * (3 * pa1->x + qa1->x) + f1g * fg * fg * (3 * pa2->x - qa2->x) + fg * fg * fg * pa2->x);
      pa->y= (short) (f1g * f1g * f1g * pa1->y + f1g * f1g * fg * (3 * pa1->y + qa1->y) + f1g * fg * fg * (3 * pa2->y - qa2->y) + fg * fg * fg * pa2->y);
