...
#define DIALOG()                                                       \
  ...
  msg [ nmsgs ].type= AUTH_MSGTYPE_INFO;
  msg [ nmsgs ].msg=
    "2/4 All work and no play makes Jack a dull boy. " "All work and no play makes Jack a dull boy. ";
  nmsgs++;
  ...
  msg [ nmsgs ].msg=
    "1/1 Page Five visible text" "over several lines, probably like three or four; y and g.";
  nmsgs++;
  ...
  msg [ nmsgs ].type= AUTH_MSGTYPE_INFO;
  msg [ nmsgs ].msg=
    "3/3 \xF0\x9F\x92\xA9 \xF0\x9F\x92\xA9 \xF0\x9F\x92\xA9"
    " \xE2\x80\x9C"
    " \xE2\xAC\xA4 \xE2\x80\xA2 \xE2\xAD\x98 " "\xE2\x80\x9D";
  nmsgs++;
  DIALOG();
