...
extern gboolean image_text_pref_changed_event_cb(GtkWidget *, GdkEvent *, gpointer user_data);
extern void mode_menu_item_cb(GtkWidget *, gpointer user_data);
extern void switch_page_cb(GtkNotebook *, GtkWidget *, gint page_num, gpointer user_data);
...
extern void settings_switch_page_cb(GtkNotebook *, GtkWidget *, gint page_num, gpointer user_data);
...
extern gboolean file_chooser(GtkWindow *, GtkEntry *, char **retP, const char *title, gboolean verbose_p, gboolean dir_p, gboolean program_p);
