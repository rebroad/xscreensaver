...
#define ORG_KDE_KWIN_DPMS_MANAGER_GET_SINCE_VERSION 1
  ...
  /** @ingroup iface_org_kde_kwin_dpms_manager */
  static inline void
    org_kde_kwin_dpms_manager_set_user_data(
      struct org_kde_kwin_dpms_manager *org_kde_kwin_dpms_manager,
      void *user_data)
  {
  ...
  /** @ingroup iface_org_kde_kwin_dpms_manager */
  static inline void *
    org_kde_kwin_dpms_manager_get_user_data(
      struct org_kde_kwin_dpms_manager *org_kde_kwin_dpms_manager)
  {
  ...
  static inline uint32_t
    org_kde_kwin_dpms_manager_get_version(
      struct org_kde_kwin_dpms_manager *org_kde_kwin_dpms_manager)
  {
      ...
      struct wl_output *output)
  {
    ...
    id= wl_proxy_marshal_flags((struct wl_proxy *) org_kde_kwin_dpms_manager,
      ...
      wl_proxy_get_version((struct wl_proxy *) org_kde_kwin_dpms_manager),
      0,
      NULL,
      output);
...
#define ORG_KDE_KWIN_DPMS_MODE_ENUM
   ...
   */
  static inline int
    org_kde_kwin_dpms_add_listener(
      struct org_kde_kwin_dpms *org_kde_kwin_dpms,
      const struct org_kde_kwin_dpms_listener *listener,
      void *data)
  {
...
#define ORG_KDE_KWIN_DPMS_RELEASE_SINCE_VERSION 1
  ...
  /** @ingroup iface_org_kde_kwin_dpms */
  static inline void
    org_kde_kwin_dpms_set_user_data(
      struct org_kde_kwin_dpms *org_kde_kwin_dpms,
      void *user_data)
  {
  ...
  /** @ingroup iface_org_kde_kwin_dpms */
  static inline void *
    org_kde_kwin_dpms_get_user_data(
      struct org_kde_kwin_dpms *org_kde_kwin_dpms)
  {
      ...
      uint32_t mode)
  {
    wl_proxy_marshal_flags((struct wl_proxy *) org_kde_kwin_dpms,
      ORG_KDE_KWIN_DPMS_SET,
      NULL,
      wl_proxy_get_version((struct wl_proxy *) org_kde_kwin_dpms),
      0,
      mode);
  }
