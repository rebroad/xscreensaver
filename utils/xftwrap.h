 ...
 */
extern int XftTextExtentsUtf8_multi(Display *, XftFont *, const FcChar8 *, int L, XGlyphInfo *);

/* Like XftDrawStringUtf8, but handles multi-line strings.
   Alignment is 1, 0 or -1 for left, center, right.
 */
extern void XftDrawStringUtf8_multi(XftDraw *, const XftColor *, XftFont *, int x, int y, const FcChar8 *, int L, int alignment);
