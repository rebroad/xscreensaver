...
#define PREMATURE_EOF { in = end; goto DONE; }
  ...
  if ((c & 0xC0) == 0x80)
    { /* 10xxxxxx - lonely continuation byte */
      uc= INVALID;
    }
  else if ((c & 0x80) == 0)
...
#define URC "\357\277\275"   /* 0xFFFD, "Unicode Replacement Character" */
  ...
  static const struct
  {
      const char *name, *in, *target, *target2;
  } tests []= {
    ...
    {"3.1.5", /*  4 continuation bytes: */ "\200\277\200\277", URC URC URC URC},
    {"3.1.6", /*  5 continuation bytes: */ "\200\277\200\277\200", URC URC URC URC URC},
    {"3.1.7", /*  6 continuation bytes: */ "\200\277\200\277\200\277", URC URC URC URC URC URC},
    {"3.1.8", /*  7 continuation bytes: */ "\200\277\200\277\200\277\200", URC URC URC URC URC URC URC},
    ...
    {"4.1.4", /* U+002F = f8 80 80 80 af    = */ "\370\200\200\200\257", URC},
    {"4.1.5", /* U+002F = fc 80 80 80 80 af = */ "\374\200\200\200\200\257", URC},

    /* 4.2  Maximum overlong sequences */

    {"4.2.1", /*  U-0000007F = c1 bf             = */ "\301\277", URC},
    {"4.2.2", /*  U-000007FF = e0 9f bf          = */ "\340\237\277", URC},
    {"4.2.3", /*  U-0000FFFF = f0 8f bf bf       = */ "\360\217\277\277", URC},
    {"4.2.4", /*  U-001FFFFF = f8 87 bf bf bf    = */ "\370\207\277\277\277", URC},
    ...
    {"4.3.4", /*  U+0000 = f8 80 80 80 80    = */ "\370\200\200\200\200", URC},
    {"4.3.5", /*  U+0000 = fc 80 80 80 80 80 = */ "\374\200\200\200\200\200", URC},
    ...
    {"6.3", /* Christmas tree */
      ...
      "\001\002\003\004\005\006\007\010\011\012\013\014\015\016\017\020" "\021\022\023\024\025\026\027\030\031\032\033\034\035\036\037" " !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ" "[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~\177" URC URC URC URC URC URC URC URC URC URC URC URC URC URC URC URC URC
  ...
  {
    const char *utf8= (
      "son \303\256le int\303\251rieure, \303\240 "
      "c\303\264t\303\251 de l'alc\303\264ve "
      "ovo\303\257de, o\303\271 les b\303\273ches "
      "se consument dans l'\303\242tre "
      "\302\251\302\256\302\261\302\274\302\275\302\276" "\303\206\303\246");
    const char *latin1= (
      "son \356le int\351rieure, \340 "
      "c\364t\351 de l'alc\364ve ovo\357de, "
      "o\371 les b\373ches se consument dans "
      "l'\342tre " "\251\256\261\274\275\276\306\346");
    const char *ascii= (
      "son ile interieure, a cote de l'alcove "
      "ovoide, ou les buches se consument dans "
      "l'atre " "(c)(r)+-1/41/23/4AEae");
     ...
     for measurement and display purposes. */
  {
    static const char *const tests []= {
      ...
      "\360\237\221\246\360\237\217\275\342\200\215" "\360\237\221\247\360\237\217\277 ",
    };
    int i;
    for (i= 0; i < sizeof(tests) / sizeof(*tests); i++)
      {
