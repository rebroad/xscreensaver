 ...
 */
extern void allocate_writable_colors(Screen *, Colormap, unsigned long *pixels, int *ncolorsP);
 ...
 */
extern void make_color_ramp(Screen *, Visual *, Colormap, int h1, double s1, double v1, int h2, double s2, double v2, XColor *colors, int *ncolorsP, Bool closed_p, Bool allocate_p, Bool *writable_pP);
 ...
 */
extern void make_color_loop(Screen *, Visual *, Colormap, int h1, double s1, double v1, int h2, double s2, double v2, int h3, double s3, double v3, XColor *colors, int *ncolorsP, Bool allocate_p, Bool *writable_pP);
...
/* Allocates a hopefully-interesting colormap, which will be a closed loop
   ...
   If allocate_p is false, screen, visual and cmap are unused (OpenGL usage).
 */
extern void make_smooth_colormap(Screen *, Visual *, Colormap, XColor *colors, int *ncolorsP, Bool allocate_p, Bool *writable_pP, Bool verbose_p);
...
/* Allocates a uniform colormap which touches each hue of the spectrum,
   ...
   If allocate_p is false, screen, visual and cmap are unused (OpenGL usage).
 */
extern void make_uniform_colormap(Screen *, Visual *, Colormap, XColor *colors, int *ncolorsP, Bool allocate_p, Bool *writable_pP, Bool verbose_p);
...
/* Allocates a random colormap (the colors are unrelated to one another.)
   ...
   If allocate_p is false, screen, visual and cmap are unused (OpenGL usage).
 */
extern void make_random_colormap(Screen *, Visual *, Colormap, XColor *colors, int *ncolorsP, Bool bright_p, Bool allocate_p, Bool *writable_pP, Bool verbose_p);
 ...
 */
extern void rotate_colors(Screen *, Colormap, XColor *, int ncolors, int distance);
