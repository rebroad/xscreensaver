...
static unsigned _get_cache_line_size(
  void)
{
  /*
  The general idea:
...
#if HAVE_UNISTD_H && (defined _SC_LEVEL1_DCACHE_LINESIZE || defined _SC_LEVEL2_CACHE_LINESIZE || defined _SC_LEVEL3_CACHE_LINESIZE || defined _SC_LEVEL4_CACHE_LINESIZE)
  {
